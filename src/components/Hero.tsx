      ...
      <div className="container px-4 md:px-6">
        <div className="flex flex-col-reverse md:flex-row items-center gap-8 md:gap-12">
          <div className="flex-1 text-center md:text-left">
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-4 md:mb-6 gradient-text animate-fade-in" style={{ animationDelay: "0.2s" }}>
              Vedant Kumbhare
            </h1>
            <h2 className="text-xl md:text-2xl lg:text-3xl font-semibold mb-6 md:mb-8 animate-fade-in" style={{ animationDelay: "0.4s" }}>
              Frontend Developer & UI/UX Designer
            </h2>
            <p className="text-muted-foreground text-base md:text-lg max-w-xl mx-auto md:mx-0 mb-8 animate-fade-in" style={{ animationDelay: "0.6s" }}>
              I create engaging, accessible, and high-performance web experiences with cutting-edge technologies and user-centered design principles.
            </p>
